...
INSERT INTO online_movie_store.genre_types(genre_type,genre_description) values ("Fiction","Fiction is any story or setting that is derived from imagination—in other words, not based strictly on history or fact.");
...
INSERT INTO online_movie_store.actors(actor_first_name,actor_last_name,actor_details,actor_gender) values ("Leonardo","DiCaprio","Leonardo Wilhelm DiCaprio was born November 11, 1974 in Los Angeles, California, the only child of Irmelin DiCaprio (née Indenbirken) and former comic book artist George DiCaprio.","Male");
...
INSERT INTO online_movie_store.movies(genre_type_id,video_format_type_id,release_year,movie_title,movie_description) values (3,1,2016,"The Comedian","A look at the life of an aging insult comic named Jack Burke.");
